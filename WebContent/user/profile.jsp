...
<script type="text/javascript">
	...
	function showPass(chkId, passId){
...
<div class="container card p-4">
		...
		<h2 class="text-danger" style="font-weight: bolder;font-size: 20px !important;">Hey, <% out.println(ub.getUsername());%><hr class="bg-warning"></h2>
		<div class="row">			
			<div class="col-md-3 pl-1 pr-1  border-right" >
			<form class="view zoom pl-1 pr-1 " action="<%=application.getContextPath()%>/Usercontroller" method="post" enctype="multipart/form-data">
			<div style="height: 400px;" class="mt-3">
					<img src="../uploadimg/<%=ub.getPhoto()%>" class="pl-1 pr-1 mt-5 img-fluid img-thumbnail bg-warning img-responsive h-50 w-100">
			</div>
			...
			<div class="col-md-9 p-3 border-right" >
				<form class=" " method="post" action="<%=application.getContextPath()%>/Usercontroller" data-parsley-validate>
					
					<div class="form-group">
						<label for="user">User Name</label>
						<input type="text" name="user" required id="user" data-parsley-length="[3,20]" value="<% out.println(ub.getUsername());%>" class="form-control" disabled>
					</div>
					<div class="form-group">
						<label for="mobno">Mobile Number</label>
						<input type="text" name="mobno" data-parsley-type="integer" required minlength="10" maxlength="10" data-parsley-error-message="It should be valid mobile number" id="mobno" value="<%out.println(ub.getMobnum()); %>" class="form-control" disabled>
					</div>
					<div class="form-group">
						<label for="email">E-mail</label>
						<input type="text" name="email" required id="email1" data-parsley-length="[1,256]" value="<%out.println(ub.getMail()); %>" placeholder="E-mail" class="form-control"  disabled>
					</div>
					<div class="form-group">
						<label for="address">Address</label>
						<textarea name="address" rows="5" required id="address" data-parsley-length="[1,100]" placeholder="Address" style="resize:none" class="form-control" disabled><%out.println(ub.getAdd()); %></textarea>
					</div>
...
<div id="forgot_password_form" class="modal fade" role="dialog" style="margin-top:150px;">
	<div class="modal-dialog modal-md">
		...
		<div class="modal-content">
			<form method="post" action="<%=application.getContextPath()%>/Usercontroller" data-parsley-validate="true">
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-6 col-lg-6">
							...
							<%
							 ...
							 String pwd = Userdao.decrypt(pwd1);									
							%>
								<div class="adminpwd">
								...
								<div class="systempwd" style="display:none;">	
									<div class="form-group">
										...
										<%
										 ...
										 String pwd4 = Userdao.decrypt(pwd1);									
										%>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
		 		<form method="post" action="<%=application.getContextPath()%>/Usercontroller" data-parsley-validate="true">
	                 <div class="form-group">                   
	                      <input type="text" class="form-control" placeholder="User Name" name="updateuser" data-parsley-length="[3,20]" value="<%=ub.getUsername()%>" required><br>                             
	                      <input type="text" class="form-control" placeholder="Mail" name="updatemail" data-parsley-type="email" value="<%=ub.getMail()%>" required><br>
	                      <input type="text" class="form-control" placeholder="Mobile No." name="updatemobile" data-parsley-type="digits" value="<%=ub.getMobnum()%>" required><br>
	                      <input type="text" class="form-control" placeholder="Address" name="updateaddress"  data-parsley-minlength="3" data-parsley-maxlength="50" value="<%=ub.getAdd()%>" required><br>
...
<div id="edit_photo" class="modal fade" role="dialog" style="margin-top:150px;">
	<div class="modal-dialog modal-md">
		<!-- Modal content-->
		<div class="modal-content">
			<form method="post" action="<%=application.getContextPath()%>/Usercontroller" data-parsley-validate="true" enctype="multipart/form-data">
			<div class="modal-header mb-3 bg-danger">

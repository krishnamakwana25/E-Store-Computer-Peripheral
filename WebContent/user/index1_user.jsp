	...
	<div class="banner-bottom">
		<div class="container"> 
			<div class="banner-bottom-grids">
				...
				<a href="getAllMouseKeyboardByUser.jsp">
				...
				<a href="getAllCamerasByUser.jsp">
				...
				<a href="getAllPrinterByUser.jsp">
					...
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="side animated wow slideInUp">
							<div class="img">							
								...
								<button type="hidden" type="submit" name="action" value="quickviewByUserId" class="btnquickview">
							...
							<div class="btn_div p-2">				
									...
									%> 
										...
										<form action="<%=application.getContextPath()%>/WishlistController" method="post">
											...
											<%-- <input type="hidden" name="pid1" id="pid1" value="<% out.println(product.getProductid());%>"> --%>
											<%	 											
											boolean t = Wishlistdao.getWishListByProUserId(product.getProductid(),ub.getUserid()) ;											
											if(t)
											{												
												%>
												<a class="like ">
...
<!-- collections-bottom -->
	<div class="collections-bottom" style="padding-top: 0px;">	
		<div class=" container">
			<a href="CustomizeProductById.jsp">

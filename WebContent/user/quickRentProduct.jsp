		...
		<div class="row mt-5">
			...
			<div class="col-sm-6 col-md-6 col-lg-6 pl-4">
				<div class="product-details">
					...
					<%
					  	int p = Integer.parseInt(rent.getRentProductPrice());
						int r = 1;
						int total = p * r ;
					%>
							...
							<div class="add" style="display: inline-block;">												
								<div class="float-left">
									<form action="<%=application.getContextPath()%>/RentProdController1"  method="post">
										...
										<inut type="hidden" name="price" value="<%=p %>">
										<input type="hidden" name="totalamt" value="<%=total%>">
										<!-- <input type="submit" class="item_add btn btn-md btn-primary float-left" name="action" value="On Rent"> -->

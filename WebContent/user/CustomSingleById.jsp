	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="col-sm-1 col-md-1 col-lg-1">
				<div class="pdct-small-img">
					<img src="../uploadimg/<%=product1.getCustprophoto1() %>" onclick="myFunction(this)" style="width: 80px; height:70px;border: 1px solid gray;">
					<img src="../uploadimg/<%=product1.getCustprophoto2() %>" onclick="myFunction(this)" style="width: 80px; height:70px;border: 1px solid gray;">
					<img src="../uploadimg/<%=product1.getCustprophoto3() %>" onclick="myFunction(this)" style="width: 80px; height:70px;border: 1px solid gray;">
					<img src="../uploadimg/<%=product1.getCustprophoto4() %>" onclick="myFunction(this)" style="width: 80px; height:70px;border: 1px solid gray;">
				</div>
					...
					<div class="product-add-to-cart">
						...
						<div class="add" style="display: inline-block;">							
							<%-- <form action="<%=application.getContextPath()%>/CustListController"  method="post">
	           	  				<input type="hidden" name="cpid" id="cpid" value="<% out.println(product1.getCustproid());%>">         	  
							...
							<%	 						
									boolean t = CustListDao.getListByProUserId(proid,ub.getUserid());
									if(!t)
									{
									%> 																			
									<form action="<%=application.getContextPath()%>/CustListController"  method="post">
		    	       	  				...
		    	       	  				<input type="hidden" name="catid" value="<%=product1.getCustmaincatid()%>">                	  	
										<input type="submit" class="item_add btn btn-primary float-left" name="action" value="Add to List">
									</form>	
									<%
									}

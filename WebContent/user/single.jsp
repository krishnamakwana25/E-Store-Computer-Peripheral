...
<%	
	...
	System.out.println("sub category  : "+subcatname);
				...
				<div class="row p-2">
					<%		
						int flag=0;
							...
							List<Productbean> list1 = Productdao.getRelatedFourProduct(subcatname);
						...
						<div class="side animated wow slideInUp">
							<div class="img">							
								...
								<input type="hidden" name="productid" id="productid" value="<% out.println(product1.getProductid());%>">								
						  		<input type="hidden" name="maincatid" value="<%=product1.getSubcatname()%>">

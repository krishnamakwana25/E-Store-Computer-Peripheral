...
<%
	...
	ResultSet rs = null;
	String query = null, query1 = null, brand = "", ram = "", processor = "", graphicscard = "", hdd = "", ssd = "", feature = "";
	...
	if(request.getParameter("graphicscard") != null){
		graphicscard = request.getParameter("graphicscard");
		if(query1 != null)
			query1 += " AND graphicscard='"+graphicscard+"'";
		else
			query1 = "graphicscard='"+graphicscard+"'";	
	}
...
<div class="container mb-5">
	<div class="row mt-5">
				...
				<div class="sidebar p-3">	
					...
					<div class="side_cat mt-3">
						...
						<%-- <select class="form-control" id="processor_id" name="processor_id">
										...
										<option class="" type="radio" <% if(processor.equals("i3")) out.print("selected"); %> onclick="form.submit()" class="form-check-input" name="processor" value="i3">i3</option>
						...
						<div class="cat6_option result_div">
							...
							<div class="form-check"><label class="form-check-label"><input class="" type="radio" <% if(graphicscard.equals("2 GB")) out.print("checked"); %> onclick="form.submit()" class="form-check-input" name="graphicscard" value="2 GB">2 GB</label></div>
							<div class="form-check"><label class="form-check-label"><input class="" type="radio" <% if(graphicscard.equals("4 GB")) out.print("checked"); %> onclick="form.submit()" class="form-check-input" name="graphicscard" value="4 GB">4 GB</label></div>
							<div class="form-check"><label class="form-check-label"><input class="" type="radio" <% if(graphicscard.equals("6 GB")) out.print("checked"); %> onclick="form.submit()" class="form-check-input" name="graphicscard" value="6 GB">6 GB</label></div>
							<div class="form-check"><label class="form-check-label"><input class="" type="radio" <% if(graphicscard.equals("8 GB")) out.print("checked"); %> onclick="form.submit()" class="form-check-input" name="graphicscard" value="8 GB">8 GB</label></div>
					...
					<div class="form-group h6 mt-3 text-center">
							<button class="btn btn-danger" type="button" onclick='if(confirm("Do you want to Refresh ?")){ location.href="getAllLaptopByDealer.jsp" }'>Reset Filter</button>
						</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
				<div class="main">
					<div class="row p-2 animated wow slideInUp">
					...
					if(feature.equals("") == false){ %> 
						...
						<% while(rs.next()){ %>
					 		<div class="mb-3 col-sm-6 col-md-6 col-lg-4">
								<div class="card side  animated wow slideInUp">
									<form method="post" action="<%=application.getContextPath()%>/ProductController" >
										...
										<button type="submit" name="action" value="quickviewDealer1" class="btn btn-white">									

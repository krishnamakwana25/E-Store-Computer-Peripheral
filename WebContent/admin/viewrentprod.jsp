     ...
     <jsp:include page="header.jsp"></jsp:include>
      ...
      <section id="main-content">
          <section class="wrapper">
            <h1 class="table_heading mt-4">Rent Product Information</h1>
            <div class="row">        
         	  <!-- Form controls -->
	                  <div class="col-lg-12">
            	               ...
            	               <thead class="thead_cls">
                        	  	...
                        	  	%>
                          			<tr>
                          				...
                          				<td><img src="../uploadimg/<%=rent.getRentProPhoto1() %>" style="height:50px; width:70px"></td>
                          				<td><img src="../uploadimg/<%=rent.getRentProPhoto2() %>" style="height:50px; width:70px"></td>
                          				<td><% out.println(rent.getRentProductPrice());%></td>
                          				<td><%out.println(rent.getRentProductQty1()); %></td>
                          				<td><% out.println(rent.getRentProductSpecification1());%></td>
                          				<td class="col_a"><% out.println(rent.getRentProductDescription());%></td>
                          				<td>

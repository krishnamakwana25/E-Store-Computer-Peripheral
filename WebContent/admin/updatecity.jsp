...
<%	
	Citybean cb= Citydao.getCityById(Integer.parseInt(request.getParameter("id")));
%>
                     ...
                     <h1></h1>
                        <div class="panel-body">
                           <form class="col-lg-12" method="post" action="<%=application.getContextPath()%>/Citycontroller" data-parsley-validate="true" >
                              ...
                              <label>City Id : <a style="font-weight: bold;"><%=cb.getCid()%></a></label>
                              	<hr>
                                 <input type="text" hidden="" class="form-control" placeholder="Id" name="id" value="<%=cb.getCid()%>">
                                 <label>State Name</label>
                           		  <select class="form-control" required="required" id="updatestate" name="updatestate">    								    
										...
										{
										%>                                       
									     	 <option value="<%=state.getSid()%>" <% if(cb.getSid() == state.getSid()) out.println("selected"); %>>
                                 ...
                                 <input type="text" class="form-control" placeholder="City" name="updatecity" data-parsley-trigger="keyup" data-parsley-minlength="3" data-parsley-maxlength="30" value="<%=cb.getCityname()%>"><br>                           		 
                              </div>

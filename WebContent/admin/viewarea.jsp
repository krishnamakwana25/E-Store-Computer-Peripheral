     ...
     <jsp:include page="header.jsp"></jsp:include>
      ...
      <section id="main-content">
          <section class="wrapper">
            <h1 class="table_heading mt-4">Area Information</h1>
            <div class="row">        
         	  <!-- Form controls -->
	                  <div class="col-sm-12">
            	              ...
            	              <table id="example1" border="1"class="table table-responsive-sm table-hover">
            	               <thead class="thead_cls">
    	                      	...
    	                      	<%
            	              		...
            	              		List<Areabean> list = ad.getallArea();
                	          		for(Areabean area: list)
                    	      		{
                        	  	%>
                          			<tr>
                          				<td><% out.println(area.getAid());%></td>
                          				<td><% out.println(area.getAreaname());%></td>
                          				<td><% out.println(area.getCityname());%></td>
                          				<td><% out.println(area.getStatename());%></td>
                          				<td>
                              			<form method="post"  action="<%=application.getContextPath()%>/Areacontroller" >
                              			<input type="hidden" name="id" value="<%=area.getAid()%>">

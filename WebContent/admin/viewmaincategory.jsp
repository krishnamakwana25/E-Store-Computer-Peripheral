...
<html lang="en">
<head>
<title>Manage Main Category</title>
     ...
     <jsp:include page="header.jsp"></jsp:include>
      ...
      <section id="main-content">
          <section class="wrapper">
            <h1 class="table_heading mt-4">Main Category Information</h1>
                <div class="row">        
         	  <!-- Form controls -->
	                  <div class="col-sm-12">
        	                ...
        	                <div class="panel-bodyclass" id="example_wrapper">
            	              <table  id="example1" border="1"class="table table-responsive-xs table-hover">
            	               <thead class="thead_cls">
                        	  	...
                        	  	%>
                          			<tr>
                          				<td><% out.println(maincategory.getMaincatid());%></td>
                          				<td><% out.println(maincategory.getMaincatname());%></td>
                          				<td>
                              			<form method="post" action="<%=application.getContextPath()%>/Maincategorycontroller">
                              			<input class="text-center" type="hidden" name="id" value="<%=maincategory.getMaincatid()%>">
                                 		<input type="submit" class="btn btn-lg btn-primary" name="action" value="Edit">
                          				...
                          				<td>
                              			<form method="post" action="<%=application.getContextPath()%>/Maincategorycontroller">
                          				<input type="hidden" name="id" value="<%=maincategory.getMaincatid()%>">

...
<html lang="en">
<head>
<title>Customize Order Status</title>
     ...
     <jsp:include page="header.jsp"></jsp:include>
      ...
      <section id="main-content">
          <section class="wrapper">
            <h1 class="table_heading mt-4">Customize Order Status Information</h1>
          <div class="row">      
            <!-- <div class="tab">
            	              ...
            	              <table  id="example1" border="1"class="table table-responsive-lg table-hover">
            	               <thead class="thead_cls">
                	          	<tr>
	                          	 ...
	                          	 <%
    	                   		   	CustomOPStatusdao orsd= new CustomOPStatusdao();
            	              		List<CustomOpStatusBean> list = CustomOPStatusdao.getAllCustomOrderStatus();
                	          		for(CustomOpStatusBean ordersts: list)
                    	      		{
                        	  	%>
                          			<tr>
                          				<td><% out.println(ordersts.getStatus_id());%></td>
                          				<td><% out.println(ordersts.getCust_op_id());%></td>                          			
                          				<td><% out.println(ordersts.getUser_id());%></td>                          				                    				
                          				<td><%out.println(ordersts.getCustomizeprodid()); %></td>
